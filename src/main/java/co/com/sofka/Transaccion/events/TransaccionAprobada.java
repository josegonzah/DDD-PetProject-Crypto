...
public class TransaccionAprobada extends DomainEvent {
    ...
    public TransaccionAprobada(TransaccionId transaccionId, Valor valor, Set<Cuenta> cuenta, CuentaId cuentaId, BlockchainId blockchainId) {
